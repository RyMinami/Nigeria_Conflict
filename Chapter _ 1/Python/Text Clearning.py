...
1. **Load the Dataset**:
   - Reads the conflict event dataset from a CSV file.

2. **Text Cleaning and Event Categorization**:
   ...
   - Categorizes events into predefined categories:
     ...
     - **Strike and Clash**
     - **Other** (default)
   - Converts text to lowercase for consistent classification.

3. **Filter Data for Specific Years**:
   - Extracts conflict events from **2010, 2011, 2013, 2014, 2015, 2016, 2018, 2019**.

4. **Generate a Bar Chart**:
   - Visualizes the **number of conflict events per category**.
   - Improves chart readability with **labels, colors, and formatting**.

5. **Display and Export Data**:
   - Shows the **processed dataset** in a structured format.
   - Saves the **filtered dataset as a CSV file** for further analysis.
"""
